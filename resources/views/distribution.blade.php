        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href=" "><i class="fas fa-tachometer-alt"></i><span>Dashboard<button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">B1</button></span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="distribution"><i class="fa fa-dollar"></i><span>Money distribution<button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">M1</button></span></a></li>
                    <li class="nav-item"><a class="nav-link" href="patients"><i class="fas fa-table"></i><span>patients&nbsp;<button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">P1</button></span></a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"><a class="nav-link" href="orgchart"><i class="fa fa-area-chart"></i><span>Organisation chart<button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">C1</button></span></a></li>
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="margin-top: 12px;">
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body"><button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">M5</button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex">
                                    ...
                                    </nav><button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">M6</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card shadow" style="margin-top: 14px;">
                        ...
                        <div class="card-body">
                            ...
                            </div><button class="btn btn-primary" type="button" style="font-size: 16px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;background: var(--danger);">M7</button>
